              ...
              <div className="flex flex-col gap-2">
                {mod.videos.map((vid: any, vidIdx: number) => {
                  ...
                  const handleLessonClick = () => {
                    ...
                    if ((vid.kind === 'intro' || vid.kind === 'end') && onLessonSelect) {
