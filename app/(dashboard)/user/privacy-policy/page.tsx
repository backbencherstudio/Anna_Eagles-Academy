            ...
            <Tabs value={activeTab} onValueChange={handleTabChange} className="w-full">
                ...
                <TabsContent value="terms">
                    <div className="space-y-4 pt-2">
                        ...
                        <section className="space-y-2">
                            <h3 className="font-semibold">2. Faith-Based Educational Philosophy</h3>
                            <p className="text-sm">
                        ...
                        <section className="space-y-2">
                            ...
                            <p className="text-sm">You agree to use our services responsibly and lawfully. You may not:</p>
                            <ul className="list-disc pl-6 space-y-1 text-sm">
                        ...
                        <section className="space-y-2">
                            <h3 className="font-semibold">4. Enrollment and Participation</h3>
                            <p className="text-sm">
                        ...
                        <section className="space-y-2">
                            <h3 className="font-semibold">7. Privacy and Data Use</h3>
                            <p className="text-sm">
                                Your privacy is important to us. Any personal information collected is handled in
                                accordance with our Privacy Policy. By using our services, you consent to such
                                collection and use.
