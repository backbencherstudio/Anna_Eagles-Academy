...
import CompletionStatusPieChart from '@/app/(dashboard)/_components/Admin/Report/CoursesProgress/CompletionStatusPieChart'
import CourseCompletionRatesChart from '@/app/(dashboard)/_components/Admin/Report/CoursesProgress/CourseCompletionRatesChart'
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from '@/components/ui/select'
import CourseDetailsTable from '@/app/(dashboard)/_components/Admin/Report/CoursesProgress/CourseDetailsTable'
